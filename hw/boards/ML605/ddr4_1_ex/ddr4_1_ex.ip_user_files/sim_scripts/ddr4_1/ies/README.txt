...
#
# Generated by export_simulation on Tue Jul 20 14:32:07 +0900 2021
#
################################################################################
...
'-reset_run' switch to the './ddr4_1.sh' script.
...
./ddr4_1.sh -noclean_files

For more information on the script, please type './ddr4_1.sh -help'.
