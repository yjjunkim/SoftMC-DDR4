...
#
# Generated by export_simulation on Thu Jun 24 15:21:54 +0900 2021
#
################################################################################
...
'-reset_run' switch to the './rdback_fifo.sh' script.

./rdback_fifo.sh -reset_run
...
./rdback_fifo.sh -noclean_files

For more information on the script, please type './rdback_fifo.sh -help'.
