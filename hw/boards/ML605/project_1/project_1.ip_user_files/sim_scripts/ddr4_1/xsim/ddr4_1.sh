...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ddr4_1 xil_defaultlib.ddr4_1 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ddr4_1 -key {Behavioral:sim_1:Functional:ddr4_1} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_9c58.protoinst" -protoinst "protoinst_files/bd_9c58.protoinst" -protoinst "protoinst_files/bd_9c58.protoinst" -protoinst "protoinst_files/bd_9054.protoinst" -log simulate.log
}
