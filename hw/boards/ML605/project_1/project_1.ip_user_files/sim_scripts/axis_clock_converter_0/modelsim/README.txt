...
#
# Generated by export_simulation on Thu Jul 29 15:47:42 +0900 2021
#
################################################################################
...
'-reset_run' switch to the './axis_clock_converter_0.sh' script.

./axis_clock_converter_0.sh -reset_run
...
./axis_clock_converter_0.sh -noclean_files

For more information on the script, please type './axis_clock_converter_0.sh -help'.
