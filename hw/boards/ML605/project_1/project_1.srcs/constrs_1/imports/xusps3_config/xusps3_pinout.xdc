...
#create_clock -period 10.000 [get_ports c0_sys_clk_n]
set_clock_groups -group [get_clocks c0_sys_clk_p -include_generated_clocks] -asynchronous
...
create_clock -period 10.000 -name refclk_100 [get_ports sys_clk_p] 
