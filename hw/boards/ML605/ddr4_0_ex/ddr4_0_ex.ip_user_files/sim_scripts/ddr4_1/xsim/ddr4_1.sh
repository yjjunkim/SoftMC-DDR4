...
elaborate()
{
  xelab --relax --debug typical --mt auto -L microblaze_v11_0_4 -L xil_defaultlib -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_13 -L lmb_v10_v3_0_11 -L lmb_bram_if_cntlr_v4_0_19 -L blk_mem_gen_v8_4_4 -L iomodule_v3_1_6 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ddr4_1 xil_defaultlib.ddr4_1 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ddr4_1 -key {Behavioral:sim_1:Functional:ddr4_1} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_9054.protoinst" -protoinst "protoinst_files/bd_9c58.protoinst" -log simulate.log
}
...
map_local_libs()
{
  ...
  local_libs=(microblaze_v11_0_4 lib_cdc_v1_0_2 proc_sys_reset_v5_0_13 lmb_v10_v3_0_11 lmb_bram_if_cntlr_v4_0_19 blk_mem_gen_v8_4_4 iomodule_v3_1_6)
